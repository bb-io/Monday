...
{
    public class DynamicTestErrorHandler : BaseInvocable, IDataSourceHandler
    {
        public DynamicForContextRequest Input { get; set; }

        public DynamicTestErrorHandler(InvocationContext invocationContext,
        ...
        public Dictionary<string, string> GetData(DataSourceContext context)
        {
            Dictionary<string, string> dictionary = new()
            {
                ...
                {
                    "Dynamic Input Another",
                    !string.IsNullOrEmpty(Input.DynamicInputAnother)
                        ? Input.DynamicInputAnother
                        : throw new ArgumentException("Fill in Dynamic Input Another value")
                },
